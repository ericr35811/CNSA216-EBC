    ...
    <form id="FormPhysician" runat="server">
       <div class="formdiv">
           ...
           <div>
                 ...
                 <asp:TextBox ID="txtMiddle" runat="server" Width="5em"CausesValidation="true"></asp:TextBox>
           ...
           <div>
               ...
               <asp:TextBox ID="txtPhone" runat="server" TextMode="Phone"CausesValidation="true"></asp:TextBox> <br />
           ...
           <div>
               ...
               <asp:TextBox ID="txtStreet" runat="server"CausesValidation="true"></asp:TextBox> <br />
               ...
               <small>City</small><br />
               <asp:TextBox ID="txtCity" runat="server"CausesValidation="true"></asp:TextBox><br />
               ...
               <asp:TextBox ID="txtZip" runat="server"CausesValidation="true"></asp:TextBox>
           ...
           <div>
               ...
               <asp:TextBox ID="txtStartDate" runat="server" TextMode="Date"CausesValidation="true"></asp:TextBox><br />
               ...
               <asp:TextBox ID="txtEndDate" runat="server" TextMode="Date"CausesValidation="true"></asp:TextBox>
