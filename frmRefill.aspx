...
<asp:Content ID="Content2" ContentPlaceHolderID="ASPContent" runat="server">
   <form id="form1" runat="server">
     <div>
     <asp:Label ID="lblPatientID" Text="PatientID:" runat="server"></asp:Label> <br />
     <asp:TextBox ID="txtPatientID" ReadOnly="True" runat="server"></asp:TextBox><br />
    ...
    <br />
     ...
     <asp:TextBox ID="txtDate" ReadOnly="true" runat="server" TextMode="Date"></asp:TextBox>&nbsp&nbsp
