   ...
   <form id="form1" runat="server">
    ...
    <br />
     ...
     <asp:Label ID="lblDate" runat="server" Text="Today's Date:"></asp:Label>
         <asp:TextBox ID="txtDateTime" ReadOnly="false" runat="server" TextMode="DateTime"></asp:TextBox>&nbsp&nbsp
     ...
     <asp:Label ID="lblClerkName"  runat="server" Text="Clerck's Name:"></asp:Label>
         ...
         <br />
         <br />
         <asp:Button ID="btnSave" runat="server" Text="Confirm Refill" OnClick="btnSave_Click1" />
